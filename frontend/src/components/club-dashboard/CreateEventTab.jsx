      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-text-secondary dark:text-text-dark-secondary">Publish a new club event with schedule, details, and poster.</p>
          </div>
          <Button
            type="button"
            variant="secondary"
        ...
        <form onSubmit={handleCreateEvent} className="space-y-5">
          ...
          <section className="space-y-4 rounded-xl border border-border-subtle bg-white p-5 dark:border-border-strong dark:bg-[#1a2632] sm:p-6">
                  ...
                  <button key={tag.value} type="button" onClick={() => setNewEvent((previous) => ({ ...previous, tag: tag.value }))}
                    className={`flex flex-1 items-center justify-center rounded-xl border py-2 text-sm font-medium transition-all ${
                      newEvent.tag === tag.value
                        ...
                        : 'border-border-subtle text-text-secondary hover:border-primary/40 hover:text-primary dark:border-border-strong dark:text-text-dark-secondary'
                    }`}>
          ...
          <section className="space-y-4 rounded-xl border border-border-subtle bg-white p-5 dark:border-border-strong dark:bg-[#1a2632] sm:p-6">
              ...
              <div
                className={`rounded-xl border-2 border-dashed p-4 transition-colors ${
                  isCreatePosterDragActive
                    ...
                    : 'border-border-subtle bg-surface-muted dark:border-border-strong dark:bg-[#0f1720]/40'
                }`}
            ...
            {newEvent.is_paid && (
              <div className="space-y-4 rounded-lg border border-border-subtle p-4 dark:border-border-strong">
                <div>
          ...
          <Button type="submit" disabled={creating || creatingPoster} className="w-full">
