    ...
    <div className="flex flex-col h-full bg-white dark:bg-surface-panel">
      ...
      {selectedEvent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 safe-area-y" onClick={() => setSelectedEvent(null)}>
          <div
            className="bg-white dark:bg-[#1a2632] rounded-2xl shadow-2xl w-full max-w-5xl modal-panel overflow-y-auto border border-border-subtle dark:border-border-strong"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex h-full flex-col md:flex-row">
              <div className="w-full md:w-2/5 aspect-[4/5] md:aspect-auto bg-[#0f1720] relative overflow-hidden">
