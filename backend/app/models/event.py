...
class Event(Base):
    ...
    payment_qr_storage_path = Column(String(700), nullable=True)
    payment_qr_mime_type = Column(String(100), nullable=True)
    payment_qr_size_bytes = Column(Integer, nullable=True)
    payment_qr_uploaded_at = Column(DateTime, nullable=True)
    payment_qr_deleted_at = Column(DateTime, nullable=True)
